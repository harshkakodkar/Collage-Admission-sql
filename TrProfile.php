...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (!empty($first_name) && !empty($last_name) && !empty($phone_number) && !empty($address)) {
        ...
        $update_sql = "UPDATE teachers SET FirstName = '$first_name', LastName = '$last_name', PhoneNumber = '$phone_number', Address = '$address', Photo = '$image_url' WHERE Email = '$email'";
        ...
        if (!empty($new_password)) {
            $update_password_sql = "UPDATE teachers SET Password = '$new_password' WHERE Email = '$email'";
  ...
  <div class="profile">
    <div class="content">
      ...
      <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" enctype="multipart/form-data">
        ...
        <fieldset>
          <input type="button" class="Btn cancel" value="Cancel" onclick="window.location.href='TrDashboard.php'" />
