...
if ($studentID) {
    ...
    $sql = "SELECT s.*, ed.*, c.CourseName, s.Photo AS StudentPhoto
            ...
            WHERE s.StudentID = ? AND a.CourseID = 101";
        ...
        <div class="row">
            ...
            <div class="container">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="post" action="update_status.php"> <!-- Updated form action -->

                            <!-- Display student photo if available -->
                            <?php if (!empty($student['StudentPhoto'])) : ?>
                                <div class="form-group">
                                    <center>
                                        <img src="http://localhost/college/<?php echo $student['StudentPhoto']; ?>" class="img-thumbnail" alt="Student Photo">
                                    </center>
                                </div>
                            <?php endif; ?>
