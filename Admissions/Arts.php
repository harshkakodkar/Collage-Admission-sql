...
$teacherName = "Teacher"; 
$teacherImageURL = "http://localhost/college/Resources/no_pp.png"; 
...
<body class="h-100">
    <div class="container-fluid h-100">
        <div class="row h-100">
            ...
            <div class="col-10">
                <div class="container">
                    <h2 class="text-center">Student List - Arts Course</h2>
...
function storeStudentID(studentID) {
    ...
    xhttp.onreadystatechange = function() {
        if (this.readyState == 4 && this.status == 200) {
            ...
            window.location.href = "store_student_id_arts.php?studentID=" + studentID;
        }
    };
    xhttp.open("GET", "store_student_id_arts.php?studentID=" + studentID, true);
    xhttp.send();
}

function filterStudents(status) {
    var url = 'filter_arts.php?status=' + status;
    fetch(url)
