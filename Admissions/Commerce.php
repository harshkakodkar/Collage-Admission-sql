...
<body class="h-100">
    <div class="container-fluid h-100">
        <div class="row h-100">
            ...
            <div class="col-10">
                <div class="container">
                    <h2 class="text-center">Student List - Commerce Course</h2>
...
function storeStudentID(studentID) {
    ...
    xhttp.onreadystatechange = function() {
        if (this.readyState == 4 && this.status == 200) {
            ...
            window.location.href = "store_student_id_commerce.php?studentID=" + studentID;
        }
    };
...
function filterStudents(status) {
    var url = 'filter_commerce.php?status=' + status;
    fetch(url)
